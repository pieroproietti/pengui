...
try:
    ...
    from PySide6.QtGui import QFont, QPalette, QTextCursor         # type: ignore
    from PySide6.QtWidgets import QApplication, QStyle, QTextEdit  # type: ignore
except ImportError:
    raise
...
DEFAULT_TTY_FONT = QFont('Noto', 12)
